...
--
-- Host: localhost    Database: iot_log_dev
-- ------------------------------------------------------
...
CREATE TABLE `sys_logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=209951 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Dumping events for database 'iot_log_dev'
--

--
-- Dumping routines for database 'iot_log_dev'
--
...
-- Dump completed on 2023-10-31  0:18:28
